...
ajax_search_price.addEventListener('click', () => {
    ...
    $high = document.getElementById('price_high').value;
    $low = document.getElementById('price_low').value;
    ...
    fetch('ajax-test/show_price', { // 第1引数に送り先
        method: 'POST',
        ...
        res.forEach(elm =>{
            ...
            var insertHTML = "<tr class=\"target\">" + insertID + insertIMG + insertName + insertPrice + insertprice + insertCompanyName + insertShow_btn + insertDel_btn + "</tr>"
